                    ...
                    return __extends(i, r),
                        ...
                        i.prototype.load = function(t) {
                            ...
                            function a() {
                                ...
                                c.indexOf("edge") >= 0 && document.body.removeChild(s)
                            }
                            var o = this;
                            this.url = t;
                            var s = new Audio(t);
                            ...
                            c.indexOf("edge") >= 0 && document.body.appendChild(s),
                                s.load(),
                                this.originAudio = s,
                ...
                var r = function(t) {
                    ...
                    return __extends(r, t),
                        ...
                        r.prototype.checkFullScreen = function(t) {
                            var r = this.video;
                            if (t) null == r.parentElement && (r.removeAttribute("webkit-playsinline"), document.body.appendChild(r)),
                                e.stopTick(this.markDirty, this),
                                this.goFullscreen();
                            else if (null != r.parentElement && r.parentElement.removeChild(r), r.setAttribute("webkit-playsinline", "true"), this.setFullScreenMonitor(!1), e.startTick(this.markDirty, this), e.Capabilities.isMobile) return this.video.currentTime = 0,
            ...
            function(t) {
                var r = function() {
                    ...
                    return t.prototype.isInputOn = function() {
                        ...
                        t.prototype.disconnectStageText = function(e) { (null == this._stageText || this._stageText == e) && (this.clearInputElement(), this._inputElement && this._inputElement.blur()),
                            this._needShow = !1
                        },
                    ...
                    return Object.defineProperty(e.prototype, "width", {
                        ...
                        e.prototype.resize = function(e, t, r) {
                            ...
                            if (r) {
                                ...
                                n || (this.context.globalCompositeOperation = "source-over", this.context.setTransform(1, 0, 0, 1, 0, 0), this.context.globalAlpha = 1)
                            } else i.width != e && (i.width = e),
                    ...
                    return __extends(r, t),
                        ...
                        r.prototype.getLocation = function(t) {
                            ...
                            var r = document.documentElement,
                                ...
                                c = t.pageY - a,
                                l = c;
                            return 90 == this.rotation ? (s = c, l = i.width - o) : -90 == this.rotation && (s = i.height - c, l = o),
                                s /= this.scaleX,
                                l /= this.scaleY,
                ...
                var a = function(r) {
                    ...
                    return __extends(i, r),
                        i.$init = function() {
                            ...
                            c == n.WEB_AUDIO && a || c == n.HTML5_AUDIO ? (s = !1, i.setAudioType(c)) : (s = !0, i.setAudioType(n.HTML5_AUDIO)),
                                r.indexOf("android") >= 0 ? s && a && i.setAudioType(n.WEB_AUDIO) : (r.indexOf("iphone") >= 0 || r.indexOf("ipad") >= 0 || r.indexOf("ipod") >= 0) && i.getIOSVersion() >= 7 && (i._canUseBlob = !0, s && a && i.setAudioType(n.WEB_AUDIO));
                ...
                function i(r) {
                    if (!s) {
                        ...
                        if (i.indexOf("egretnative") >= 0 && -1 == i.indexOf("egretwebview") && (e.Capabilities.runtimeType = e.RuntimeType.RUNTIME2), i.indexOf("egretnative") >= 0 && e.nativeRender) egret_native.addModuleCallback(function() {
                            ...
                            e.sys.CanvasRenderBuffer = t.CanvasRenderBuffer,
                            i.indexOf("egretnative") >= 0 && "webgl" != l && (e.$warn(1051), l = "webgl"),
                                n(l);
                            var u = void 0;
                ...
                var r = function() {
                    ...
                    return t.prototype.addFps = function() {
                        ...
                        t.prototype.update = function(e, t) {
                            ...
                            this.showPanle && (m += "<br/>min" + s + " max" + c + " avg" + x, this.divDraw.innerHTML = this.lastNumDraw + "<br/>", this.divCost.innerHTML = '<font  style="color:#18fefe">' + i + '<font/> <font  style="color:#ff0000">' + n + "<font/>"),
                ...
                var r = function(r) {
                    ...
                    return __extends(i, r),
                        i.prototype.init = function(r, i) {
                            ...
                            var h = new t.HTMLInput; (n.showFPS || n.showLog) && (e.nativeRender || l.displayFPS(n.showFPS, n.showLog, n.logFilter, n.fpsStyles)),
                                this.playerOption = n,
                                this.container = r,
                                this.canvas = s,
                                this.stage = a,
                    ...
                    return e.prototype.reachMaxSize = function(e, t) {
                        ...
                        e.prototype.cacheArrays = function(e, t, r, i, n, a, o, s, c, l, h, u, d, f, p) {
                            var v = e.globalAlpha,
                                ...
                                T = e.$offsetX,
                                S = e.$offsetY;
                            if ((0 != T || 0 != S) && (w = T * y + S * m + w, E = T * x + S * b + E), !d) { (0 != a || 0 != o) && (w = a * y + o * m + w, E = a * x + o * b + E);
                                var _ = s / i;
                                1 != _ && (y = _ * y, x = _ * x);
                                var C = c / n;
                                1 != C && (m = C * m, b = C * b)
                            ...
                            if (d) {
                                var R = this.vertices,
                                    ...
                                    B = 0,
                                    O = 0;
                                for (D = 0, A = u.length; A > D; D += 2) $ = L + 5 * D / 2,
                                    B = d[D],
                                    O = d[D + 1],
                                    M = u[D],
                                    I = u[D + 1],
                                    R[$ + 0] = y * B + m * O + w,
                                    R[$ + 1] = x * B + b * O + E,
                                    p ? (R[$ + 2] = (t + (1 - I) * n) / l, R[$ + 3] = (r + M * i) / h) : (R[$ + 2] = (t + M * i) / l, R[$ + 3] = (r + I * n) / h),
                                    R[$ + 4] = v;
                                if (this.hasMesh) for (var P = 0,
                                                           W = f.length; W > P; ++P) this.indicesForMesh[this.indexIndex + P] = f[P] + this.vertexIndex;
                ...
                var r = function(t) {
                    ...
                    return __extends(r, t),
                        r.prototype.resize = function(e, t) {
                            ...
                            this.width = e,
                                this.height = t,
                            this.frameBuffer && (r.bindTexture(r.TEXTURE_2D, this.texture), r.texImage2D(r.TEXTURE_2D, 0, r.RGBA, e, t, 0, r.RGBA, r.UNSIGNED_BYTE, null)),
                ...
                var i = function() {
                    ...
                    return i.getInstance = function(e, t) {
                        ...
                        i.prototype.resize = function(e, t, r) {
                            var i = this.surface;
                            r ? (i.width < e && (i.width = e), i.height < t && (i.height = t)) : (i.width != e && (i.width = e), i.height != t && (i.height = t)),
                                this.onResize()
                        },
                        ...
                        i.prototype.drawMesh = function(e, t, r, i, n, a, o, s, c, l, h, u, d, f, p, v, g) {
                            ...
                            if (!this.contextLost && e && y) {
                                var x, m, b;
                                if (e.texture || e.source && e.source.texture) x = e.texture || e.source.texture,
                                    y.saveTransform(),
                                    m = y.$offsetX,
                                    b = y.$offsetY,
                                    y.useOffset(),
                        ...
                        i.prototype.drawRect = function(e, t, r, i) {
                            var n = this.currentBuffer; ! this.contextLost && n && (this.vao.reachMaxSize() && this.$drawWebGL(), this.drawCmdManager.pushDrawRect(), this.vao.cacheArrays(n, 0, 0, r, i, e, t, r, i, r, i))
                        },
                                ...
                                switch (e.type) {
                                    ...
                                    case 6:
                                        if (this.activatedBuffer) {
                                            var o = this.activatedBuffer.rootRenderTarget; (0 != o.width || 0 != o.height) && o.clear(!0)
                                        }
                                        break;
                                    case 7:
                                    ...
                                    case 10:
                                        n.bindTexture(n.TEXTURE_2D, e.texture),
                                            e.smoothing ? (n.texParameteri(n.TEXTURE_2D, n.TEXTURE_MAG_FILTER, n.LINEAR), n.texParameteri(n.TEXTURE_2D, n.TEXTURE_MIN_FILTER, n.LINEAR)) : (n.texParameteri(n.TEXTURE_2D, n.TEXTURE_MAG_FILTER, n.NEAREST), n.texParameteri(n.TEXTURE_2D, n.TEXTURE_MIN_FILTER, n.NEAREST))
                                }
                                return r
                            }
                        },
                ...
                var r = function(r) {
                    ...
                    return __extends(n, r),
                        ...
                        n.prototype.getPixels = function(t, r, i, n) {
                            ...
                            for (var s = new Uint8Array(4 * i * n), c = 0; n > c; c++) for (var l = 0; i > l; l++) {
                                var h = 4 * (i * (n - c - 1) + l),
                                    u = 4 * (i * c + l),
                                    d = a[u + 3];
                        ...
                        n.prototype.transform = function(e, t, r, i, n, a) {
                            var o = this.globalMatrix,
                                ...
                                c = o.b,
                                l = o.c,
                                h = o.d; (1 != e || 0 != t || 0 != r || 1 != i) && (o.a = e * s + t * l, o.b = e * c + t * h, o.c = r * s + i * l, o.d = r * c + i * h),
                                o.tx = n * s + a * l + o.tx,
                                o.ty = n * c + a * h + o.ty
                        },
                        ...
                        return a.prototype.render = function(t, r, i, a) {
                            ...
                            a.prototype.drawWithFilter = function(t, a, o, s) {
                                ...
                                if (!t.mask && 1 == h.length && ("colorTransform" == h[0].type || "custom" === h[0].type && 0 === h[0].padding)) {
                                    ...
                                    if (!t.$children || 1 == y) return u && a.context.setGlobalCompositeOperation(l),
                            ...
                            a.prototype.drawWithClip = function(t, a, o, s) {
                                ...
                                if (d || t.$children && 0 != t.$children.length) {
                                    ...
                                    if (m.context.pushBuffer(m), l += this.drawDisplayObject(t, m, -v, -g), d) {
                                        ...
                                        m.context.drawTexture(b.rootRenderTarget.texture, 0, 0, E, T, 0, 0, E, T, E, T),
                                    ...
                                    if (m.context.setGlobalCompositeOperation(i), m.context.popBuffer(), l > 0) {
                                        ...
                                        a.context.drawTexture(m.rootRenderTarget.texture, 0, 0, C, R, 0, 0, C, R, C, R),
                                        u && m.context.popMask(),
                            ...
                            a.prototype.renderBitmap = function(t, n) {
                                ...
                                if (a) {
                                    ...
                                    } else for (; h > u;) n.context.drawImage(a, l[u++], l[u++], l[u++], l[u++], l[u++], l[u++], l[u++], l[u++], t.imageWidth, t.imageHeight, t.rotated, t.smoothing);
                            ...
                            a.prototype.renderMesh = function(t, n) {
                                ...
                                if (p == p && (g = n.globalAlpha, n.globalAlpha *= p), t.filter) {
                                    ...
                                    n.context.$filter = null
                                } else for (; h > u;) n.context.drawMesh(c, l[u++], l[u++], l[u++], l[u++], l[u++], l[u++], l[u++], l[u++], t.imageWidth, t.imageHeight, t.uvs, t.vertices, t.indices, t.bounds, t.rotated, t.smoothing);
                                if (f && n.context.setGlobalCompositeOperation(i), p == p && (n.globalAlpha = g), d) {
                                    var y = n.globalMatrix;
                                    y.a = a.a,
                                        y.b = a.b,
                            ...
                            a.prototype.renderText = function(r, i) {
                                ...
                                if (! (0 >= n || 0 >= a) && n && a && 0 != r.drawData.length) {
                                    ...
                                    if ((r.$canvasScaleX != o || r.$canvasScaleY != s) && (r.$canvasScaleX = o, r.$canvasScaleY = s, r.dirtyRender = !0), this.canvasRenderBuffer && this.canvasRenderBuffer.context ? r.dirtyRender && this.canvasRenderBuffer.resize(n, a) : (this.canvasRenderer = new e.CanvasRenderer, this.canvasRenderBuffer = new t.CanvasRenderBuffer(n, a)), this.canvasRenderBuffer.context) {
                                        ...
                                        (l || h) && (r.dirtyRender && this.canvasRenderBuffer.context.setTransform(o, 0, 0, s, 0, 0), i.transform(1, 0, 0, 1, -l / o, -h / s)),
                                            r.dirtyRender = !1
                                    }
                                }
                            },
                            a.prototype.renderGraphics = function(r, i, n) {
                                ...
                                if (! (0 >= a || 0 >= o) && a && o && 0 != r.drawData.length) {
                                    var s = e.sys.DisplayList.$canvasScaleX,
                                        c = e.sys.DisplayList.$canvasScaleY; (1 > a * s || 1 > o * c) && (s = c = 1),
                                    (r.$canvasScaleX != s || r.$canvasScaleY != c) && (r.$canvasScaleX = s, r.$canvasScaleY = c, r.dirtyRender = !0),
                                        a *= s,
                                        o *= c;
                                    var l = Math.ceil(a),
                                        h = Math.ceil(o);
                                    if (s *= l / a, c *= h / o, a = l, o = h, this.canvasRenderBuffer && this.canvasRenderBuffer.context ? (r.dirtyRender || n) && this.canvasRenderBuffer.resize(a, o) : (this.canvasRenderer = new e.CanvasRenderer, this.canvasRenderBuffer = new t.CanvasRenderBuffer(a, o)), this.canvasRenderBuffer.context) { (1 != s || 1 != c) && this.canvasRenderBuffer.context.setTransform(s, 0, 0, c, 0, 0),
                            ...
                            a.prototype.createRenderBuffer = function(e, r) {
                                var i = n.pop();
                                return i ? i.resize(e, r) : (i = new t.WebGLRenderBuffer(e, r), i.$computeDrawCall = !1),
                                    i
                            },
                            a
                    } ();
